document.addEventListener('DOMContentLoaded', () => {
    ...
    enterButton.addEventListener('click', () => {
        ...
        personalizedGreeting.innerHTML = `<span>${guestName}</span>, saiba que cada nova versão é feita de boas histórias — e a sua presença torna essa ainda mais inesquecível 🥂`;
